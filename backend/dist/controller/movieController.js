...
const topRatedMovie = async (req, res) => {
    try {
...
const getTrailerWithFallback = async (req, res) => {
    const { id } = req.params;
...
export { getPopularMovie, watchMovie, topRatedMovie, upcomingMovies, getTrailerWithFallback, getMovieDetails, searchMovie };
